...
namespace DSPAlgorithms.Algorithms
{
    public class FIR : Algorithm
    {
        ...
        {
            float delta = InputTransitionBand / InputFS;
            int N=0;
            float n;
            ...
            {
                float fdash = (float)((InputCutOffFrequency + (InputTransitionBand / 2)) / InputFS);
                if (InputStopBandAttenuation <= 21)
                {
                    N = (int)Math.Ceiling(0.9 / delta);
                    n = (int)((N - 1) / 2);
                    if (N % 2 == 0)
                        N++;
                    ...
                    for (int i = (int)-(n); i <= n; i++)
                    {
                        ...
                        if (i == 0)
                        {
                            ...
                            hn.Add((float)(2 * fdash * Math.Sin(i * 2 * Math.PI * fdash) / (i * 2 * Math.PI * fdash)));
                        indicies.Add(i);
